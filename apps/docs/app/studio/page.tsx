...
export default function StudioPage() {
  return <main className="studio-page">
    ...
    <StudioDemo />
    <footer className="studio-page-footer"><span>Free, open source, and yours to host.</span><Link href="/support">Support Tourlight ↗</Link><span>Real React player · Portable JSON · No account</span></footer>
  </main>
}
