...
The Studio and agent additions are available in this source checkout. Until a
release containing them is published, use the repository's local setup to try
them. The npm installation below provides the published package version.
