---
title: Introduction
description: Install react-spotlight and build your first onboarding tour in under 5 minutes.
---

## Installation

Install react-spotlight and its peer dependency:
...
react-spotlight ships a small CSS file for the overlay and transitions. Import it once at the root of your app:
...
```tsx
import { useSpotlight } from 'react-spotlight'
