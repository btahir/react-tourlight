...
Sometimes you don't need a multi-step tour. You just want to draw attention to a single element -- a new feature, a changed button, or an important action. react-spotlight provides two ways to do this.
...
import { SpotlightHighlight } from 'react-spotlight'
...
```tsx
import { useSpotlightControl } from 'react-spotlight'
