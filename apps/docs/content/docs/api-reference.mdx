...
| `interactive` | `boolean` | `false` | Forward click events through the overlay to the highlighted element. Only click events are forwarded — hover and other interactions on the target still go to the dimmed overlay |
