---
title: Accessibility
description: react-spotlight is WCAG 2.1 AA compliant with focus trapping, keyboard navigation, ARIA attributes, and screen reader support.
---

react-spotlight is designed to be accessible out of the box. No additional configuration is needed to meet WCAG 2.1 AA compliance.
...
react-spotlight respects the `prefers-reduced-motion` media query. When this preference is enabled:
...
Here's a summary of the accessibility features built into react-spotlight:
