...
react-spotlight's `renderTooltip` prop gives you full control over the tooltip UI. This recipe shows how to build a tooltip using shadcn/ui's `Card` and `Button` components so your tour matches the rest of your app.
...
import type { TooltipRenderProps } from 'react-spotlight'
